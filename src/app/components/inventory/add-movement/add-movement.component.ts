...
import {ModalDismissReasons, NgbCalendar, NgbDate, NgbDateAdapter, NgbDateParserFormatter, NgbModal} from '@ng-bootstrap/ng-bootstrap';
...
export class AddMovementComponent implements OnInit {
    ...
    dateIssue: NgbDate = this.calendar.getToday();
    //cabecera
    ...
    ngOnInit(): void {
        ...
        //inicizar
        this.SaleForm.get('issue_date').setValue(this.today);
    ...
    onSave() {
        ...
        let movement: Inventory = {
            id: 0,
            issue_date: this.SaleForm.value.issue_date,
            serie: this.serie,
